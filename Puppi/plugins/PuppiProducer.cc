...
//	itPF = *(PFCol[pfLoop]);
	...
	//if (std::count((vtxmap->at(currentVertex).begin()),vtxmap->at(currentVertex).end(),*lPackEdmPtr)) 
		...
		//std::cout << "DEBUG " << lpv->position()<< " "<< currentVertex->position() <<std::endl ;
		...
		pReco.dZ = pDZ;
		pReco.d0 = pD0;
		//std::cout<<"DEBUG pvtxid "<<  pVtxId << ", closestVtx==0? "<<  (closestVtx==0) << std::endl;
		//	std::cout<< "DEBUG " << lPack->vertex().Z()  << ", charge " << lPack->charge() << ", pdz " << pDZ << std::endl;
...
/*	std::cout << "DEBUG counter0 " << counter0<< std::endl;
	std::cout << "DEBUG counter1 " << counter1<< std::endl;
	std::cout << "DEBUG counter2 " << counter2<< std::endl;
	std::cout << "DEBUG counter3 " << counter3<< std::endl;
	std::cout << "DEBUG counter4 " << counter4<< std::endl;
	std::cout << "DEBUG counterFindVtx " << counterFindVtx<< std::endl;*/
